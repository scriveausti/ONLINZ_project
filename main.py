# imports the functions from other files
...
# runs all the imported functions in the right order
if __name__ == '__main__':
    ...
    print("user's name : {} {}, user's address : {}, user's phone number : {}, total returning price : ${}".format(
